...
import 'control_panel_properties_model.dart';
export 'control_panel_properties_model.dart';

class ControlPanelPropertiesWidget extends StatefulWidget {
  const ControlPanelPropertiesWidget({
    super.key,
    this.pagename,
  });
  ...
  @override
  State<ControlPanelPropertiesWidget> createState() =>
      _ControlPanelPropertiesWidgetState();
}

class _ControlPanelPropertiesWidgetState
    extends State<ControlPanelPropertiesWidget> with TickerProviderStateMixin {
  late ControlPanelPropertiesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ControlPanelPropertiesModel());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<ExtraServiceRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<ExtraServiceRecord> controlPanelPropertiesExtraServiceRecordList =
            snapshot.data!;
