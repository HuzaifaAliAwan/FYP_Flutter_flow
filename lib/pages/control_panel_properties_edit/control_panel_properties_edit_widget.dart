...
import 'control_panel_properties_edit_model.dart';
export 'control_panel_properties_edit_model.dart';

class ControlPanelPropertiesEditWidget extends StatefulWidget {
  const ControlPanelPropertiesEditWidget({
    super.key,
  ...
  @override
  State<ControlPanelPropertiesEditWidget> createState() =>
      _ControlPanelPropertiesEditWidgetState();
}

class _ControlPanelPropertiesEditWidgetState
    extends State<ControlPanelPropertiesEditWidget> {
  late ControlPanelPropertiesEditModel _model;
    ...
    return StreamBuilder<List<ExtraServiceRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<ExtraServiceRecord>
            controlPanelPropertiesEditExtraServiceRecordList = snapshot.data!;
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    Padding(
                      padding:
                          const EdgeInsetsDirectional.fromSTEB(0.0, 50.0, 10.0, 0.0),
                      child: Container(
                    ...
                    children: [
                      ...
                      StreamBuilder<List<ExtraServiceRecord>>(
                        ...
                        builder: (context, snapshot) {
                          ...
                          List<ExtraServiceRecord>
                              dropDownExtraServiceRecordList = snapshot.data!;
                          ...
                          onPressed: () async {
                            await widget.propertyId!.update({
                              ...createPropertyRecordData(
                                ...
                                name:
                                    _model.inputPropertyNameTextController.text,
                                description: _model
                                    .inputPropertyDescriptionTextController
                                    .text,
                              ...
                              ...mapToFirestore(
                                {
                                  'extraServices':
                                      controlPanelPropertiesEditExtraServiceRecordList
                                          .map((e) => e.reference)
                                          .toList(),
                                },
                              ),
                            ...
                            await showDialog(
                              ...
                              builder: (alertDialogContext) {
                                return AlertDialog(
                                  ...
                                  content:
                                      const Text('The property has been updated'),
                                  actions: [
                                    TextButton(
                                      onPressed: () =>
