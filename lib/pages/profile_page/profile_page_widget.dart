...
class _ProfilePageWidgetState extends State<ProfilePageWidget>
  ...
  void initState() {
    ...
    _model.nameTextController ??= TextEditingController(text: 'Huzaifa Ali');
    _model.nameFocusNode ??= FocusNode();

    _model.emailTextController ??=
        TextEditingController(text: 'huzaifa@gmail.com');
    ...
    _model.cnicTextController ??= TextEditingController(text: '123456789213');
    _model.cnicFocusNode ??= FocusNode();

    _model.contactTextController ??= TextEditingController(text: '03001234567');
