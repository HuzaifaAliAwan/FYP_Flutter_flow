...
class _HomePageWidgetState extends State<HomePageWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      FFAppState().homeSearchActive = false;
      safeSetState(() {});
    });
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<PropertyRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<PropertyRecord> homePagePropertyRecordList = snapshot.data!;
                            ...
                            if (!FFAppState().homeSearchActive)
                              Padding(
                                ...
                                child: Builder(
                                  builder: (context) {
                                    final property =
                                        homePagePropertyRecordList.toList();
                                      ...
                                      itemBuilder: (context, propertyIndex) {
                                        ...
                                        return Column(
                                          ...
                                          children: [
                                            PropertyCardWidget(
                                              key: Key(
                                                  'Keyr8q_${propertyIndex}_of_${property.length}'),
                                              propertyReference:
                                      ...
                                      itemBuilder:
                                        ...
                                        return Column(
                                          ...
                                          children: [
                                            PropertyCardWidget(
                                              key: Key(
                                                  'Key62v_${searchPropertyIndex}_of_${searchProperty.length}'),
                                              propertyReference:
                                          ...
                                          child: Container(
                                            ...
                                            child: Autocomplete<String>(
                                              ...
                                              optionsBuilder:
                                                ...
                                                return homePagePropertyRecordList
                                                    .map((e) => e.name)
                                                    .toList()
                                                    .where((option) {
