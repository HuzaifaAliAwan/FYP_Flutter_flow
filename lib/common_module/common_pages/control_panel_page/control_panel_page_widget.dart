...
import 'control_panel_page_model.dart';
export 'control_panel_page_model.dart';

class ControlPanelPageWidget extends StatefulWidget {
  const ControlPanelPageWidget({
    super.key,
    this.pagename,
  });
...
class _ControlPanelPageWidgetState extends State<ControlPanelPageWidget> {
  late ControlPanelPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ControlPanelPageModel());
                ...
                Expanded(
                  child: Padding(
                    ...
                    child: GridView(
                      ...
                      children: [
                        if (currentUserDocument?.role == UserType.propertyOwner)
                          Align(
                            alignment: AlignmentDirectional(0.0, 0.0),
                                        ...
                                        children: [
                                          ClipRRect(
                                            borderRadius:
                                                BorderRadius.circular(8.0),
                                            child: Image.asset(
                                              'assets/images/extraService.png',
                                              width: 120.0,
                                              height: 100.0,
                                              fit: BoxFit.contain,
                                            ),
