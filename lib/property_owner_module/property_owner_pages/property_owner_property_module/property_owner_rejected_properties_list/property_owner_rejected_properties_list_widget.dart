...
import 'property_owner_rejected_properties_list_model.dart';
export 'property_owner_rejected_properties_list_model.dart';

class PropertyOwnerRejectedPropertiesListWidget extends StatefulWidget {
  const PropertyOwnerRejectedPropertiesListWidget({super.key});

  @override
  State<PropertyOwnerRejectedPropertiesListWidget> createState() =>
      _PropertyOwnerRejectedPropertiesListWidgetState();
}

class _PropertyOwnerRejectedPropertiesListWidgetState
    extends State<PropertyOwnerRejectedPropertiesListWidget> {
  late PropertyOwnerRejectedPropertiesListModel _model;
  ...
  void initState() {
    super.initState();
    _model =
        createModel(context, () => PropertyOwnerRejectedPropertiesListModel());
    ...
    return StreamBuilder<List<PropertyRecord>>(
      stream: queryPropertyRecord(
        queryBuilder: (propertyRecord) => propertyRecord
            ...
            .where(
              'approvalStatus',
              isEqualTo: PropertyApprovalType.rejected.serialize(),
            ),
      ),
      builder: (context, snapshot) {
        ...
        List<PropertyRecord>
            propertyOwnerRejectedPropertiesListPropertyRecordList =
            snapshot.data!;
                                      ...
                                      itemBuilder: (context, propertyIndex) {
                                        ...
                                        return Column(
                                          ...
                                          children: [
                                            PropertyCardWidget(
                                              key: Key(
                                                  'Keyjmv_${propertyIndex}_of_${property.length}'),
                                              propertyReference:
                                      ...
                                      itemBuilder:
                                        ...
                                        return Column(
                                          ...
                                          children: [
                                            PropertyCardWidget(
                                              key: Key(
                                                  'Keyr3x_${searchPropertyIndex}_of_${searchProperty.length}'),
                                              propertyReference:
                                          ...
                                          child: Container(
                                            ...
                                            child: Autocomplete<String>(
                                              ...
                                              optionsBuilder:
                                                ...
                                                return propertyOwnerRejectedPropertiesListPropertyRecordList
                                                    .map((e) => e.name)
                                                    .toList()
                                                    .where((option) {
