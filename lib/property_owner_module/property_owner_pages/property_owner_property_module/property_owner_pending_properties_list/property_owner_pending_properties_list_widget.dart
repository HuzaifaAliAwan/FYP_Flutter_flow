...
import 'property_owner_pending_properties_list_model.dart';
export 'property_owner_pending_properties_list_model.dart';

class PropertyOwnerPendingPropertiesListWidget extends StatefulWidget {
  const PropertyOwnerPendingPropertiesListWidget({super.key});

  @override
  State<PropertyOwnerPendingPropertiesListWidget> createState() =>
      _PropertyOwnerPendingPropertiesListWidgetState();
}

class _PropertyOwnerPendingPropertiesListWidgetState
    extends State<PropertyOwnerPendingPropertiesListWidget> {
  late PropertyOwnerPendingPropertiesListModel _model;
  ...
  void initState() {
    super.initState();
    _model =
        createModel(context, () => PropertyOwnerPendingPropertiesListModel());
    ...
    return StreamBuilder<List<PropertyRecord>>(
      stream: queryPropertyRecord(
        queryBuilder: (propertyRecord) => propertyRecord
            ...
            .where(
              'approvalStatus',
              isEqualTo: PropertyApprovalType.pending.serialize(),
            ),
      ),
      builder: (context, snapshot) {
        ...
        List<PropertyRecord>
            propertyOwnerPendingPropertiesListPropertyRecordList =
            snapshot.data!;
                                      ...
                                      itemBuilder: (context, propertyIndex) {
                                        ...
                                        return Column(
                                          ...
                                          children: [
                                            PropertyCardWidget(
                                              key: Key(
                                                  'Keyqyh_${propertyIndex}_of_${property.length}'),
                                              propertyReference:
                                      ...
                                      itemBuilder:
                                        ...
                                        return Column(
                                          ...
                                          children: [
                                            PropertyCardWidget(
                                              key: Key(
                                                  'Key3c4_${searchPropertyIndex}_of_${searchProperty.length}'),
                                              propertyReference:
                                          ...
                                          child: Container(
                                            ...
                                            child: Autocomplete<String>(
                                              ...
                                              optionsBuilder:
                                                ...
                                                return propertyOwnerPendingPropertiesListPropertyRecordList
                                                    .map((e) => e.name)
                                                    .toList()
                                                    .where((option) {
